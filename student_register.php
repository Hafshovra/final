...
<!-- Start Content -->
    <div class="row m50_0" align="middle" style="">
    	<div class="col-md-5 col-sm-5 col-xs-12"> 
          <form action="" method="post" enctype="multipart/form-data">
            ...
            <select class="form-control modal_form" name="sem">
                ...
                <option value="4-1">3-1</option>
                <option value="4-2">3-2</option>
            </select>
		...
		<div class="col-md-7 col-sm-7 col-xs-12" ><img src="images/ad_course.png"></div>
